...
class AppColor{
  ...
  static const Color mainBackColor=Color(0xFF332d2b);
  static const Color yellowColor=Color(0xFFffd379);
  static const Color appBarColor=Color(0xFFfffde7);
  static const Color t7Color=Color(0xFFffb74d);
  static const Color tealColor=Color(0xFF008e76);
